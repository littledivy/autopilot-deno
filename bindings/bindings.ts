...
const _lib = await Plug.prepare(opts, {
  notify: { parameters: [ "buffer", "usize" ], result: "void", nonblocking: false }, mouse_pixel_color_r: { parameters: [  ], result: "u8", nonblocking: false }, mouse_pixel_color_g: { parameters: [  ], result: "u8", nonblocking: false }, screenshot: { parameters: [ "buffer", "usize" ], result: "void", nonblocking: false }, screensize_height: { parameters: [  ], result: "f64", nonblocking: false }, mouse_pos_y: { parameters: [  ], result: "f64", nonblocking: false }, mouse_pixel_color_b: { parameters: [  ], result: "u8", nonblocking: false }, alert: { parameters: [ "buffer", "usize" ], result: "void", nonblocking: false }, toggle_key: { parameters: [ "buffer", "usize" ], result: "void", nonblocking: false }, screensize_width: { parameters: [  ], result: "f64", nonblocking: false }, mouse_pos_x: { parameters: [  ], result: "f64", nonblocking: false }, screenscale: { parameters: [  ], result: "f64", nonblocking: false }, smooth_mouse_move: { parameters: [ "buffer", "usize" ], result: "void", nonblocking: false }, type_: { parameters: [ "buffer", "usize" ], result: "void", nonblocking: false }, mouse_scroll: { parameters: [  ], result: "void", nonblocking: false }, tap: { parameters: [ "buffer", "usize" ], result: "void", nonblocking: false }, mouse_click: { parameters: [ "buffer", "usize" ], result: "void", nonblocking: false }, mouse_move: { parameters: [ "buffer", "usize" ], result: "void", nonblocking: false }, mouse_pixel_color_a: { parameters: [  ], result: "u8", nonblocking: false } });
...
export type MouseClickParams =   "Left"  |
  "Middle"  |
  "Right";
